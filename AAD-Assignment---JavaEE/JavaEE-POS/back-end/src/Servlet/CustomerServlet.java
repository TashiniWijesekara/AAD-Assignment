        ...
        switch (option) {
            ...
            case "loadAllCustomer":
                try (Connection connection = dataSource.getConnection()) {
                    ...
                    job.add("state", "Ok");
                    job.add("message", "It Successfully Loaded !");
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try (Connection connection = dataSource.getConnection()) {
            ...
            if (b) {
                ...
                responseObject.add("message", "It Successfully added !");
    ...
    protected void doPut(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try (Connection connection = dataSource.getConnection()) {
            ...
            if (b) {
                JsonObjectBuilder responseObject = Json.createObjectBuilder();
                responseObject.add("state", "Ok");
                responseObject.add("message", " It Successfully Updated !");
                responseObject.add("data", "");
                resp.getWriter().print(responseObject.build());

            } else {
                throw new RuntimeException("Its a Wrong ID, Please Check your ID !");
            }
    ...
    protected void doDelete(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try (Connection connection = dataSource.getConnection()) {
            ...
            if (b) {
                JsonObjectBuilder error = Json.createObjectBuilder();
                error.add("state", "Ok");
                error.add("message", " It Successfully Deleted..!");
                error.add("data", "");
                resp.getWriter().print(error.build());

            } else {
                throw new RuntimeException("The id you provided doesnt match any customer in our records !");
            }
        } catch (RuntimeException e) {
